...
const Experience = () => {
  ...
  useEffect(() => {
<<<<<<< HEAD
    axios.get('https://astik-production.up.railway.app/api/experience')  // Make sure the API URL is correct
=======
    axios.get('astik-production.up.railway.app/api/experience')  // Make sure the API URL is correct
